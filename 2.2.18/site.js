...
data = (function() {
    ...
    tools = (function(){
        ...
        tools.pan.onSelect = function() {
            ...
            this.centerMarker = new Shape.Circle(view.center, 5);
            this.centerMarker.fillColor = "red";
        };
        ...
        tools.pan.onMouseDown = function(e) {
            ...
            this.downMarker = new Shape.Circle(downPoint, 5);
            this.downMarker.fillColor = "blue";
